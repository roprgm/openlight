...
`createRenderer` accepts `{ timer, prepare, dispose }` as its fourth argument. Preparation can cache expensive work; pending preparation coalesces newer edits before composing their nodes. Disposal releases processing resources.
