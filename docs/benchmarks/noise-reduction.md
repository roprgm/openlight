# Noise reduction measurements — PR 20

Compared main `ee4c0d7`, the previous PR head `177921c`, and the updated
...
| --- | --- | --- | --- |
| RGB 257×193, neutral | 4.60 / 5.30 | 4.50 / 4.90 | 4.50 / 5.00 |
| RGB 257×193, cached amount 50/75 | — | 6.55 / 6.80 | 6.20 / 7.10 |
| Bayer 64×48, neutral | 2.30 / 2.40 | 2.30 / 2.40 | 2.30 / 2.40 |
| Bayer 64×48, cached amount 50/75 | — | 2.30 / 2.40 | 2.30 / 2.40 |
| Blend 5000×4000, GPU timestamps | — | 410.29 / 474.55 | 411.57 / 418.26 |
| Blend 5000×4000, completed latency | — | 411.70 / 475.80 | 413.10 / 419.30 |
...
The blend median changes by +0.31%.
...
| --- | --- | --- |
| RGB 257×193 | 26706.1 ms | 27298.1 ms |
| Bayer 64×48 | 2027.0 ms | 2038.0 ms |
...
On `177921c`, add the test-only compatibility file
...
and blanks): the original PR added 1234 lines over `fccc4ca`;
the updated PR adds 1309 over `ee4c0d7`. The reorganization
