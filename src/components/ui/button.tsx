...
const button = cva(
	"cursor-pointer rounded-md px-4 py-1.5 text-xs transition-colors focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-neutral-400",
	{
		variants: {
			variant: {
				default:
