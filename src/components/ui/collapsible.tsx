	...
	return (
		<section className="shadow-ridge">
			<button
				...
				className="flex w-full cursor-pointer items-center gap-1 px-3 py-2.5 text-left text-sm text-neutral-300 transition-colors hover:bg-white/3 hover:text-neutral-100 outline-none focus-visible:bg-white/8 focus-visible:text-white"
			>
				<svg
					aria-hidden="true"
					viewBox="0 0 18 18"
