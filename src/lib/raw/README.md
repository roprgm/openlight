...
The pinned npm package includes WASM and workers. Building OpenLight needs no sibling checkout or C++ toolchain. For native source, supported layouts and rebuild instructions, see the [package README](https://github.com/roprgm/raw-webgpu).
