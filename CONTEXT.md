...
| **Layer** | A source, effect, or mask in the composition. Image layers own Develop settings; effects process the image below; masks scope their basic adjustments and child effects. Child masks add or subtract coverage. Layers compose render nodes without owning textures. |
