...
- Healing combines automatic or manually positioned Smart clone patches with local AI Remove. Repairs remain editable and each patch builds on the previous result.
