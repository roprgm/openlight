...
- Healing paints automatic or manually positioned Smart clone patches; local AI Remove fills a patch with generated content. Repairs remain editable and each patch builds on the previous result.
